...
def QuarticLightCurveFit(SN_dat):
    ...
    *Make sure that the data file and this python file are saved to the same folder
    ...
    #Background Data
    Average_Mag_r = 20.481 #SN2019gaf 20.6375 #SN2019ehk 20.481
    ### Loading in Data 
    ...
    x = Time_r[0:13] #int(Time_r[np.argmin(Mag_r)])]
    print(x)
    y = Mag_r[0:13]#int(Time_r[np.argmin(Mag_r)])]
    print(y)
    Dmag = Dmag[0:13]
    ...
    X1 = np.arange(-80,Time_r[13],.0001)  
...
SN = QuarticLightCurveFit('SN2019ehk.txt') 
